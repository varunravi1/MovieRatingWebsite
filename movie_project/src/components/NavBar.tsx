    ...
    <>
      ...
      >
        <div className="flex space-x-20 ">
          <button onClick={scrolltoHome} className="navBar mukta-bold ">
            Home
          </button>
          <button onClick={scrollToFeatures} className="navBar mukta-bold">
            Features
          </button>
          <button onClick={scrollToLogin} className="navBar mukta-bold">
            Sign In
          </button>
        </div>
      </animated.div>
